...
```python
# VIOLATION: business logic depends on a concrete infrastructure class
class OrderService:
    def __init__(self) -> None:
        self._db = DatabaseDriver()  # direct dependency on infrastructure
...
# In tests: inject a fake/mock. In production: inject the real implementation.
```
